...
var StatusSelector = function StatusSelector(props) {
  ...
  return __jsx(_material_ui_core_Select__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    ,
    style: {
      backgroundColor: colorStart //`linear-gradient(45deg, var(${colorStart}), var(${colorEnd}), ...)`//colors[props.status]['--background-start']
...
//# sourceMappingURL=index.js.5e2ae3353f604eb8ac05.hot-update.js.map