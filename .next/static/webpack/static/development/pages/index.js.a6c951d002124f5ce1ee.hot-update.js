...
var StatusSelector = function StatusSelector(props) {
  ...
  return __jsx(_material_ui_core_Select__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    ,
    style: {
      backgroundColor: "linear-gradient(45deg, var(".concat(colorStart, "), var(").concat(colorEnd, "), ...)") //colors[props.status]['--background-start']
...
//# sourceMappingURL=index.js.a6c951d002124f5ce1ee.hot-update.js.map