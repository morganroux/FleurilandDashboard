...
var StatusSelector = function StatusSelector(props) {
  ...
  return __jsx(_material_ui_core_Select__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    ,
    style: {
      background: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)' //`linear-gradient(45deg, var(${colorStart}), var(${colorEnd}), ...)`//colors[props.status]['--background-start']
...
//# sourceMappingURL=index.js.29fe96d6b1b875598d09.hot-update.js.map