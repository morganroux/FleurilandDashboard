...
var StatusSelector = function StatusSelector(props) {
  ...
  return __jsx(_material_ui_core_Select__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    ,
    style: {
      background: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)' //`linear-gradient(45deg, ${colorStart}) 30%, ${colorEnd}) 90%, ...)`//colors[props.status]['--background-start']
...
//# sourceMappingURL=index.js.649802e5b21421f66d5c.hot-update.js.map