...
var StatusSelector = function StatusSelector(props) {
  ...
  return __jsx(_material_ui_core_Select__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    ,
    style: {
      backgroundColor: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)' //`linear-gradient(45deg, var(${colorStart}), var(${colorEnd}), ...)`//colors[props.status]['--background-start']
...
//# sourceMappingURL=index.js.af185e988a1a830e0838.hot-update.js.map